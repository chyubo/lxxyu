...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{url('admin/logindl')}}" method="post">
      <div class="row cl">
...
<div class="footer">北京四月兄弟有限公司 </div>
...
$(function(){
  ...
  $('#kanbuq').click(function(){
    $('img').attr('src',captcha_src + '&_=' + Math.random());
